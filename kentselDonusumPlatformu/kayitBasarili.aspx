<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="kayitBasarili.aspx.cs" Inherits="kentselDonusumPlatformu.kayitBasarili" %>
...
<body>
<div id="topPan"> <a href="#"><img src="images/logo.gif" alt="" width="245" height="39" border="0" /></a>
  <ul>
  ...
  <h1>Kentsel Dönüşüm Platformu<br /><br />
    <span>Müteahhitler ile ev sahiplerinin buluşma noktası</span> </h1>
</div>
<div id="mainmiddlePan">
  <div id="middlePan">
    <div id="middleleftPan">
      <p><span class="boldtext">Üye kaydınız yapılmıştır. Üyeliğinizin aktif hale gelebilmesi için lütfen epostanıza gönderdiğimiz mesaj içindeki linke tıklayınız.</span>
          <br /></p>
    </div>
...
<div id="bottomPan">
  <div id="bottommiddlePan">
    ...
    <div id="bottomrightPan">
      ...
      <p><span class="boldtext">Kentsel dönüşüm öncelikle güven işidir.</span></p><br />
