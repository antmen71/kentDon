        ...
        <div id="mainmiddlePan">
            <div id="middlePan">
                <div id="middleleftPan">
                    <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click">Kontrol Paneli</asp:LinkButton>
                <br />  <br />  <table class="auto-style1">
                  ...
                  <br />  <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Güncelleme Sayfasına Git" Width="201px" />
                    <br /><br />
                </div>
