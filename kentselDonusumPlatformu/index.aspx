...
<div id="topPan"> <a href="#"><img src="images/logo.gif" alt="" width="245" height="39" border="0" /></a>
  ...
  <h1>More advanced<br />
    <span>Fusce auctor, risus nec vulputate consectetuer, metus lorem</span> </h1>
</div>
<div id="mainmiddlePan">
  <div id="middlePan">
    ...
    <div id="middlerightPan">
      ...
      <p class="online"><a href="#">24x7 hours online support</a></p>
    </div>
  </div>
</div>
<div id="bottomPan">
  <div id="bottommiddlePan">
    ...
    <div id="bottomrightPan">
      ...
      <p><span class="boldtext">sit amet, consectetuer adipiscing elit. Vestibulum liimperdiet ut, commodo vel,</span> auctor vel,</p>
      <p>mi. Etiam orci nulla, aliquet vel, pharetra in, posuere ultrices, sapien. Proin vel lacus. Integer magna. Cras mi nibh, dapibus sit amet, aliquet ut, venenatis sed, tortor. Mauris eu leo. Nulla non elit. Fusce ipsum urna, auctor eu, consequat sodales,</p>
      <h3>thingk about it <br />
        <span>Tortor. Mauris eu leo. Nulla non</span></h3>
      <p class="more"><a href="#">read more</a></p>
    </div>
  </div>
</div>
<div id="footermainPan">
  <div id="footerPan">
    ...
    <a href="#"><img src="images/footerlogo.jpg" title="Total Touch" alt="Total Touch" width="248" height="38" border="0" /></a>
